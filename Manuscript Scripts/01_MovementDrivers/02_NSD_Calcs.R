...
#'---
#'  
#' **Purpose**: This script calculates NSD based off of the GPS data
...
load("Data Management/RData/Pennsylvania/GPS Data/HensGPS2025.RData")
...
# Output dataset
write_csv(df_nsd, here("Data Management/Csvs/Hen_NSD_Data/Full/all_nsd2025.csv"))
